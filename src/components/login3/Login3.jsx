        ...
        <>
            ...
            <div className="bg-blue-400 h-screen w-screen">
                <div className="flex flex-col items-center flex-1 h-full justify-center px-4 sm:px-0">
                    <div className="container-left-login3 flex rounded-lg shadow-lg w-full sm:w-3/4 lg:w-1/2 bg-white sm:mx-0">
                                ...
                                <div className="w-full mt-4">
                                    <form className="form-horizontal w-3/4 mx-auto" method="POST" action="#">
                                        <div className="flex flex-col mt-4">
                                            <input id="email" type="text" className="flex-grow h-8 px-2 border rounded border-grey-400" name="email" value="" placeholder="Email" onChange={(e) => { }} />
                                        </div>
                                        <div className="flex flex-col mt-4">
                        ...
                        <div className="container-right-login3 hidden md:block md:w-1/2 rounded-r-lg"></div>
                    </div>
                </div>
            </div>
        </>
